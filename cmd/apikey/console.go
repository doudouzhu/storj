...
func addProjectWithKey(key *string, createRegistrationTokenAddress, activationAddress, address string, param *Param) error {
	client := http.Client{}
	...
	}
	{
		...
		request.Header.Set("Authorization", param.Token)
